...
<div class="min-w-screen min-h-screen bg-gray-200 flex items-center justify-center px-5 pb-10 pt-16">
    <div class="w-full mx-auto rounded-lg bg-white shadow-lg p-5 text-gray-700" style="max-width: 600px">
        ...
        <div class="mb-3 flex -mx-2">
            <div class="px-2  bg-blue-700 hover:bg-pink-500 text-white font-bold py-2 px-4 rounded">
                <a  href="./thanhtoanmomo.html">MOMO</a>
            </div>

            <div class="px-2 ml-2 bg-blue-700 bg-pink-500 text-white font-bold py-2 px-4 rounded">
                <a  href="#">PayPal</a>
            </div>
        </div>
        <div class="mb-3">
            <label class="font-bold text-sm mb-2 ml-1">Tên tài khoản</label>
            <div>
                <input class="w-full px-3 py-2 mb-1 border-2 border-gray-200 rounded-md focus:outline-none focus:border-indigo-500 transition-colors" placeholder="Nguyễn Minh Đức" type="text"/>
            </div>
        </div>
        <div class="mb-3">
            <label class="font-bold text-sm mb-2 ml-1">Số thẻ</label>
            <div>
        ...
        <div class="mb-3 -mx-2 flex items-end">
            <div class="px-2 w-1/2">
                <label class="font-bold text-sm mb-2 ml-1">Hết hạn</label>
                <div>
        ...
        <div class="mb-10">
            <label class="font-bold text-sm mb-2 ml-1">Mã bảo mật</label>
            <div>
...
>>>>>>> efe9a274697fdbc20bb6429f9f8d08e9d2c80731
